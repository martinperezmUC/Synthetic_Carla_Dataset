...
def main():
    ...
    parser.add_argument('--input', '-i', default='dataset.idl', help='Input IDL file generated by idl_generator.py.')
    parser.add_argument('--out', '-o', default='dynamic_types_profiles.xml', help='Output XML file.')
