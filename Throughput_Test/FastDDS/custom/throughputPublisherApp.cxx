...
throughputPublisherApp::throughputPublisherApp(const int& domain_id, std::string json_file_path)
...
void throughputPublisherApp::run() {
    ...
    while (!is_stopped()) {
        // Search frame on ram and send
        sample = preloaded_frames_[frame_count % total_json_frames];
        frame_count++; 
