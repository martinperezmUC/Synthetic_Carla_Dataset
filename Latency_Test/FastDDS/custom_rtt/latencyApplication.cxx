        ...
        const std::string& json_file_path)
{
    ...
    {
        entity = std::make_shared<latencyPublisherApp>(domain_id, samples, warmup, json_file_path);
    }
    else if (strcmp(entity_kind.c_str(), "subscriber") == 0)
    {
        entity = std::make_shared<latencySubscriberApp>(domain_id);
    }
    else
    {
