        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<data_typesApplication> app;
    ...
    else
    {
        try
        {
            app = data_typesApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&data_typesApplication::run, app);
